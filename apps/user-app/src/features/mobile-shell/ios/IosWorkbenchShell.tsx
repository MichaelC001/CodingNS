...
function ChatIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.85">
      ...
      <circle cx="9" cy="11.5" r=".95" fill="currentColor" stroke="none" />
      <circle cx="12.5" cy="11.5" r=".95" fill="currentColor" stroke="none" />
      <circle cx="16" cy="11.5" r=".95" fill="currentColor" stroke="none" />
    </svg>
  );
}
