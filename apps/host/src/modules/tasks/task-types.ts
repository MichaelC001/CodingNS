export const HOST_TASK_TYPES = {
  ...
  relayTunnelStateRefresh: "relay_tunnel.state_refresh",
  relayTunnelUsageReport: "relay_tunnel.usage_report",
  webrtcPeerSupervise: "webrtc.peer_supervise",
  ...
  workspaceDiscoveryPersistence: "workspace.discovery_persist",
  sessionDiscoveryDiagnosticsMaintenance: "session.discovery_diagnostics_maintenance",
