 ...
 * 不猜窗口，也不显示上下文占用。
 *
 * 超过 256K 的窗口统一按 256K 记录：CLI 侧已把上下文上限压到 256K（自动压缩水位
 * 随之变成窗口的 50% / 80% / 90%），两处尺子不一致时界面占用率会明显偏低。
 */
const COMMAND_CODE_MODEL_CONTEXT_WINDOWS: ReadonlyMap<string, number> = new Map([
  ["claude-fable-5", 256_000],
  ["claude-fable-5-1", 256_000],
  ["claude-haiku-4-5-20251001", 200_000],
  ["claude-opus-4-7", 256_000],
  ["claude-opus-4-8", 256_000],
  ["claude-opus-5", 256_000],
  ["claude-sonnet-4-6", 256_000],
  ["claude-sonnet-5", 256_000],
  ["deepseek/deepseek-v4-flash", 256_000],
  ["deepseek/deepseek-v4-flash-fast", 256_000],
  ["deepseek/deepseek-v4-flash-vision-exp", 256_000],
  ["deepseek/deepseek-v4-pro", 256_000],
  ["deepseek/deepseek-v4.1-flash", 256_000],
  ["google/gemini-3.1-flash-lite", 256_000],
  ["google/gemini-3.5-flash", 256_000],
  ["google/gemini-3.5-flash-lite", 256_000],
  ["google/gemini-3.6-flash", 256_000],
  ["google/gemini-3.7-flash", 256_000],
  ["google/gemini-3.8-flash", 256_000],
  ...
  ["inclusionai/ling-3.0-flash-sante:free", 256_000],
  ["meituan/longcat-2.0:free", 256_000],
  ["meta/muse-spark-1.1", 256_000],
  ["meta/muse-spark-1.2", 256_000],
  ["meta/muse-spark-1.2-contributor", 256_000],
  ["meta/muse-spark-1.3", 256_000],
  ["meta/muse-spark-1.3-contributor", 256_000],
  ["minimax/minimax-m2.7-free", 197_000],
  ["minimax/minimax-m3-free", 256_000],
  ["minimaxai/minimax-m2.5", 200_000],
  ["minimaxai/minimax-m3", 256_000],
  ["minimaxai/minimax-m3-free", 256_000],
  ...
  ["qwen/qwen3.7-flash", 256_000],
  ["qwen/qwen3.7-max", 256_000],
  ["qwen/qwen3.7-plus", 256_000],
  ["qwen/qwen3.8-27b", 256_000],
  ["qwen/qwen3.8-flash", 256_000],
  ["qwen/qwen3.8-max", 256_000],
  ["qwen/qwen3.8-max-0902", 256_000],
  ["sakana/fugu-ultra", 256_000],
  ["stepfun/step-3.5-flash", 256_000],
  ["stepfun/step-3.7-flash", 256_000],
  ["tencent/hy3", 256_000],
  ["tencent/hy3-paid", 256_000],
  ["tencent/hy4-preview", 256_000],
  ["thinkingmachines/inkling", 256_000],
  ["thinkingmachines/inkling-small", 256_000],
  ["xai/grok-4.5", 256_000],
  ["xai/grok-4.6", 256_000],
  ["xiaomi/mimo-v2.5", 256_000],
  ["xiaomi/mimo-v2.5-pro", 256_000],
  ["z-ai/glm-5.3-flash", 256_000],
  ["zai-org/glm-5", 200_000],
  ["zai-org/glm-5.2", 256_000],
  ["zai-org/glm-5.2-fast", 256_000],
  ["zai-org/glm-5.3", 256_000]
]);
